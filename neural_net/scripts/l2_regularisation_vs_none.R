...
summary(dt)
################################################################################
# TRAINING WITH NO REGULARIZATION TERM
################################################################################
softmax_training <- function(x_idx, #column indexes of input vectors 
...
no_regular_result <- l2_softmax_training(x_idx = x_idx, y_idx = y_idx, data = data,
                              training_percent = training_percent,
                              learning_rate = learning_rate,
                              iters = iters)
l2_result <- l2_softmax_training(x_idx = x_idx, y_idx = y_idx, data = data,
                              training_percent = training_percent,
                              learning_rate = learning_rate,
...
## no regularisation
no_regular_report <- data.frame(accuracy = no_regular_result$accuracy, 
                        epoch = 1:iters, 
                        loss = no_regular_result$loss)

no_regular_report <- no_regular_report[which((no_regular_report$epoch %% 500) == 0),] #keep less epoches

## l2
l2_report <- data.frame(accuracy = l2_result$accuracy, 
                        epoch = 1:iters, 
                        loss = l2_result$loss)
l2_report <- l2_report[which((l2_report$epoch %% 500) == 0),] #keep less epoches

# Plot
ggplot() +
  geom_path(data = no_regular_report, 
            mapping = aes(x = epoch, y = accuracy, colour = "Accuracy")) +
  geom_point(data = no_regular_report, 
            mapping = aes(x = epoch, y = accuracy, colour = "Accuracy"),
            shape = 0) +
  geom_path(data = l2_report, 
            mapping = aes(x = epoch, y = accuracy, colour = "L2 accuracy")) +
  geom_point(data = l2_report, 
            mapping = aes(x = epoch, y = accuracy, colour = "L2 accuracy"),
            shape = 21) +
  xlab("Epoch") + ylab("") +
...
ggplot() +
  geom_path(data = no_regular_report, 
            mapping = aes(x = epoch, y = loss, colour = "Loss")) +
  geom_point(data = no_regular_report, 
             mapping = aes(x = epoch, y = loss, colour = "Loss"),
             shape = 0) +
  geom_path(data = l2_report, 
            mapping = aes(x = epoch, y = loss, colour = "L2 loss")) +
  geom_point(data = l2_report, 
             mapping = aes(x = epoch, y = loss, colour = "L2 loss"),
             shape = 21) +
  xlab("Epoch") + ylab("") +
